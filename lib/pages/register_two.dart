...
// _pickerImage(ImageSource.camera);
                  ...
                  children: [
                    ButtonContainerWidget(color:_switch==Switch.prev?AppColors.green: AppColors.offwhite, widget: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 8.w,),
                        Text('Previous'.tr,style:_switch==Switch.prev? TextDimensions.style18500white:TextDimensions.style18500black,)
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('have account?'.tr,style: TextDimensions.style18500black,),
                    Text(' Sign in'.tr,style: TextDimensions.style18400green,),
                  ],
                )
              ],
            ),
